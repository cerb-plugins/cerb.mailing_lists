	...
	<table cellspacing="0" cellpadding="2" border="0" width="98%">
		...
		<tr>
			...
			<td width="100%">
				...
				{else}
					{$object_watchers = DAO_ContextLink::getContextLinks(CerberusContexts::CONTEXT_MAILING_LIST_BROADCAST, array($model->id), CerberusContexts::CONTEXT_WORKER)}
					{include file="devblocks:cerberusweb.core::internal/watchers/context_follow_button.tpl" context=CerberusContexts::CONTEXT_MAILING_LIST_BROADCAST context_id=$model->id full=true}
				{/if}
			</td>
		</tr>
	</table>
