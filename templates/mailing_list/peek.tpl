<form action="{devblocks_url}{/devblocks_url}" method="post" id="frmMailingListPeek">
...
<div class="buttons">
	<button type="button" class="submit" onclick="genericAjaxPopupPostCloseReloadView(null,'frmMailingListPeek','{$view_id}', false, 'mailing_list_save');"><span class="cerb-sprite2 sprite-tick-circle"></span> {$translate->_('common.save_changes')|capitalize}</button>
...
<div style="float:right;">
	<a href="{devblocks_url}c=profiles&type=mailing_list&id={$model->id}-{$model->name|devblocks_permalink}{/devblocks_url}">view full record</a>
</div>
<br clear="all">
{/if}
</form>
...
<script type="text/javascript">
	...
	$popup.one('popup_open', function(event,ui) {
		...
		$(this).dialog('option','title',"{'Mailing List'|escape:'javascript' nofilter}");
