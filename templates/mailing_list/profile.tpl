...
<div id="mailing_listTabs">
	<ul>
		...
		<li><a href="{devblocks_url}ajax.php?c=profiles&a=handleSectionAction&section=mailing_list&action=showBroadcastsTab&point={$point}&context={$page_context}&id={$page_context_id}{/devblocks_url}">{$translate->_('common.broadcasts')|capitalize} <div class="tab-badge">x</div></a></li>
