<form action="{devblocks_url}{/devblocks_url}" method="post" id="frmMailingListMemberPeek">
<input type="hidden" name="c" value="profiles">
<input type="hidden" name="a" value="handleSectionAction">
<input type="hidden" name="section" value="mailing_list_member">
...
{include file="devblocks:cerberusweb.core::internal/custom_fieldsets/peek_custom_fieldsets.tpl" context=CerberusContexts::CONTEXT_MAILING_LIST_MEMBER context_id=$model->id}
...
<fieldset style="display:none;" class="delete">
	...
	<div>
		Are you sure you want to delete this mailing list member?
	</div>
...
<div class="buttons">
	<button type="button" class="submit" onclick="genericAjaxPopupPostCloseReloadView(null,'frmMailingListMemberPeek','{$view_id}', false, 'mailing_list_member_save');"><span class="cerb-sprite2 sprite-tick-circle"></span> {$translate->_('common.save_changes')|capitalize}</button>
...
<div style="float:right;">
	<a href="{devblocks_url}c=profiles&type=mailing_list_member&id={$model->id}-{$model->name|devblocks_permalink}{/devblocks_url}">view full record</a>
</div>
<br clear="all">
{/if}
</form>
...
<script type="text/javascript">
	...
	$popup.one('popup_open', function(event,ui) {
		...
		$(this).dialog('option','title',"{'Mailing List Member'|escape:'javascript' nofilter}");
